...
<section id="comments" class="comments">
    ...
    <?php if (!$comments): ?><div class="empty-panel">暂无评论，欢迎留下第一条想法。</div><?php endif; ?>
    ...
    <form method="post" class="comment-form">
        ...
        <label><span>昵称</span><input name="nickname" maxlength="40" placeholder="2-40字" required></label>
        <label><span>QQ/邮箱</span><input name="qq" maxlength="20" placeholder="选填"></label>
        <label class="wide"><span>内容</span><textarea name="content" maxlength="1000" placeholder="说点什么（5-1000字）" required></textarea></label>
        <label><span>验证码</span><input name="captcha" inputmode="numeric" placeholder="<?= h($captcha['question']) ?>" required></label>
