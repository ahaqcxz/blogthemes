...
<section id="comments" class="comments">
    ...
    <form method="post" class="comment-form">
        ...
        <label><span>联系方式</span><input name="qq" maxlength="20" placeholder="QQ号或邮箱（选填）"></label>
        <label class="wide"><span>内容</span><textarea name="content" maxlength="1000" placeholder="说点什么吧" required></textarea></label>
