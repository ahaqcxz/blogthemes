...
<header class="site-header">
    <div class="site-wrap header-inner">
        <a class="site-logo" href="/" aria-label="<?= h($logoText) ?>"><span></span><strong><?= h($logoText) ?></strong></a>
        ...
        <nav class="site-nav" id="siteNav" aria-label="主导航">
            ...
            <form class="mobile-search" onsubmit="siteSearch('mellowMobileKeyword');return false;">
                <label class="sr-only" for="mellowMobileKeyword">搜索文章</label>
                <input id="mellowMobileKeyword" placeholder="搜索文章">
