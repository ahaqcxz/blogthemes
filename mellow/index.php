...
<header class="list-head">
    <p class="eyebrow">Mellow Garden</p>
    <h1><?= h($listTitle) ?></h1>
    <p><?= h($listDesc) ?></p>
    <div class="list-metrics">
        <span><?= (int)$siteStats['article_count'] ?> 篇文章</span>
        <span><?= (int)$siteStats['total_views'] ?> 次访问</span>
        <span>最近更新 <?= h($siteStats['last_updated_display']) ?></span>
    </div>
</header>
<div class="post-list">
    <?php if (!$listPosts): ?>
        <article class="empty-card"><h2>这里还没有内容</h2><p>换个关键词，或者先去首页看看。</p></article>
    <?php endif; ?>
...
<?php if ($pagination['pages'] > 1): ?>
    <nav class="pagination" aria-label="分页">
        ...
        ?>
        <a href="<?= h($first) ?>">首页</a><a href="<?= h($prev) ?>">上一页</a><span><?= (int)$pagination['page'] ?> / <?= (int)$pagination['pages'] ?></span><a href="<?= h($next) ?>">下一页</a><a href="<?= h($last) ?>">末页</a>
    </nav>
<?php endif; ?>
