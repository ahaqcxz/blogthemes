...
<header class="river-header">
    <div class="river-wrap river-topbar">
        <a class="river-brand" href="/">
            <span><?= h(utf8_limit($logoText, 1)) ?></span>
            <strong><?= h($logoText) ?></strong>
        </a>
        <button class="nav-toggle" type="button" onclick="document.getElementById('riverNav').classList.toggle('is-open')" aria-label="打开导航" aria-controls="riverNav">
            <span></span><span></span><span></span>
        </button>
        <nav class="river-nav" id="riverNav" aria-label="主导航">
            ...
            <form class="mobile-search" onsubmit="siteSearch('riverMobileKeyword');return false;">
                <label class="sr-only" for="riverMobileKeyword">搜索文章</label>
                <input id="riverMobileKeyword" placeholder="搜索文章">
                <button type="submit">搜索</button>
            </form>
        </nav>
    </div>
</header>
<main id="mainContent" class="river-main river-wrap">
    <section class="river-content">
