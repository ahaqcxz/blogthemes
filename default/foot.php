...
<footer class="river-footer">
    <div class="river-wrap footer-inner">
        <?php if (!empty($site['footer_link_text'])): ?>
            <a class="footer-mark" href="<?= h($site['footer_link_url']) ?>" target="_blank" rel="noopener"><?= h($site['footer_link_text']) ?></a>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <p><a href="/rss.xml" target="_blank">RSS订阅</a><span> · PHP执行时间 <?= h(number_format(microtime(true) - ($_SERVER['REQUEST_TIME_FLOAT'] ?? microtime(true)), 6)) ?> 秒</span></p>
    </div>
</footer>
<script>
