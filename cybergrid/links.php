...
<article class="read-panel reveal">
    <header class="read-head">
        <p class="terminal-line">open --route links</p>
        <h1>友链导航</h1>
        <p>常用站点与朋友链接。</p>
    </header>
    <section class="link-section">
        <div class="section-head"><p class="panel-kicker">NAVIGATION</p><h2>常用导航</h2></div>
        <div class="link-grid">
    ...
    <section class="link-section">
        <div class="section-head"><p class="panel-kicker">FRIENDS</p><h2>友情链接</h2></div>
        <div class="link-grid">
