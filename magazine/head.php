...
<header class="site-header">
    <div class="site-wrap header-inner">
        <a class="site-logo" href="/"><span>墨刊</span><strong><?= h($logoText) ?></strong></a>
        ...
        <nav class="site-nav" id="siteNav" aria-label="主导航">
            ...
            <form class="mobile-search" onsubmit="siteSearch('magazineMobileKeyword');return false;">
                <label class="sr-only" for="magazineMobileKeyword">搜索文章</label>
                <input id="magazineMobileKeyword" placeholder="搜索文章">
