...
<header class="site-header">
    <div class="site-wrap header-inner">
        <a class="site-logo" href="/"><span><?= h(utf8_limit($logoText, 1)) ?></span><strong><?= h($logoText) ?></strong></a>
        ...
        <nav class="site-nav" id="siteNav" aria-label="主导航">
            ...
            <form class="mobile-search" onsubmit="siteSearch('swissMobileKeyword');return false;">
                <label class="sr-only" for="swissMobileKeyword">搜索文章</label>
                <input id="swissMobileKeyword" placeholder="搜索文章">
