...
<header class="site-header">
    <div class="site-wrap header-inner">
        <a class="site-logo" href="/"><?= h($logoText) ?></a>
        ...
        <nav class="site-nav" id="siteNav">
            ...
            <form class="mobile-search" onsubmit="siteSearch('cleanMobileKeyword');return false;">
                <label class="mobile-search-label" for="cleanMobileKeyword">搜索文章</label>
                <input id="cleanMobileKeyword" placeholder="搜索文章">
